...
import seoProject from "./assets/seo-project.png";
import passwordProject from "./assets/password-generator.png";
import hackathonProject from "./assets/hackathon-uiux.png";
      ...
      <section id="projects" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {projects.map((project) => (
            ...
            >
              <div className="h-40 rounded-2xl overflow-hidden mb-5">
  <img
    src={project.image}
    alt={project.title}
